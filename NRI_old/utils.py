...
def load_data(batch_size=1, suffix=''):
    ...
    feature_folder = os.path.join(root,'features','train')
    train_data = dataset(feature_folder)
    feature_folder = os.path.join(root,'features','validation')
    valid_data = dataset(feature_folder)
